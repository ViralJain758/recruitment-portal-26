...
export const SecurityModal = () => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-[#111827]/30 dark:bg-black/50 backdrop-blur-sm select-none">
      <Card className="max-w-md w-full border-[#FECACA] dark:border-[rgba(161,161,170,0.18)] bg-white dark:bg-[#1a1a1a] p-6">
        <div className="flex items-center gap-3 text-[#dc2626] dark:text-slate-100 mb-4">
        ...
        <div className="space-y-3 mb-6">
          <p className="text-sm text-[#374151] dark:text-slate-300">
            Violation Detected: <span className="text-[#dc2626] dark:text-slate-100 font-mono font-bold bg-[#EF4444]/10 dark:bg-white/5 px-2 py-0.5 rounded">{securityViolationType}</span>
          </p>
          <p className="text-xs text-[#b45309] dark:text-slate-400 leading-relaxed font-medium">
