...
export const QuestionCard = () => {
  ...
  return (
    <Card className="border-[#E5E7EB] dark:border-slate-700 bg-white dark:bg-slate-900 flex flex-col justify-between h-full overflow-hidden p-4 sm:p-6 shadow-[0_18px_45px_rgba(15,23,42,0.06)]">
      <div className="flex flex-col h-full overflow-hidden">
        ...
        <div className="mb-5">
          <div className="flex items-center justify-between gap-3 mb-2">
            ...
            <span className="text-[10px] font-extrabold text-[#0067B8] dark:text-blue-300 font-mono whitespace-nowrap">{answeredCount} of {totalQuestions} Answered</span>
          </div>
        ...
        <div className="flex-1 overflow-y-auto pr-1 space-y-5 select-none">
          <div className="flex flex-wrap items-center justify-between gap-2 pb-3 border-b border-[#E5E7EB] dark:border-slate-700">
          ...
          {(svgMarkup || (imageSource && !imageFailed)) && (
            <div className="w-full min-h-[132px] bg-slate-50 dark:bg-slate-950 border border-[#E5E7EB]/60 dark:border-slate-700 rounded-lg px-3 py-3 sm:px-4 flex justify-center items-center overflow-hidden">
              {svgMarkup ? (
                <div
