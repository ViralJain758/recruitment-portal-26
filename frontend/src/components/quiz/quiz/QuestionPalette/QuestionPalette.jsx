...
export const QuestionPalette = () => {
  ...
  return (
    <Card className="p-4 border-[#E5E7EB] bg-white lg:flex-1 overflow-hidden flex flex-col">
      <div className="flex items-center justify-between gap-3 mb-3">
        <h4 className="text-xs font-bold text-[#6B7280] tracking-wider uppercase select-none">Question Palette</h4>
        <span className="text-[11px] font-semibold text-[#94A3B8]">{questions.length} total</span>
      </div>
