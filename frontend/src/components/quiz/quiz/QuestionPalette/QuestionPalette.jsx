...
export const QuestionPalette = () => {
  ...
  return (
    <Card className="p-4 border-[#E5E7EB] dark:border-[rgba(161,161,170,0.18)] bg-white dark:bg-[#1a1a1a] lg:flex-1 lg:min-h-[220px] shrink-0 lg:shrink overflow-hidden flex flex-col">
